...
class BertConfig(object):
    ...
    def __init__(self,
                 vocab_size,  # 词典代销
                 hidden_size=768,  # ？？？
                 num_hidden_layers=12,  # transformer的 blocks数量？？？
                 num_attention_heads=12,  # head 数量
...
class BertModel(object):
    ...
    input_mask = tf.constant([[1, 1, 1], [1, 1, 0]])  # 不明白为什么均为1
    ...
    def __init__(self,
        ...
        batch_size = input_shape[0]  # 训练的batch大小
...
def embedding_postprocessor(input_tensor,
    ...
    Args:
      ...
      max_position_embeddings: int. Maximum sequence length that might ever be used with this model. This can be longer
         than the sequence length of input_tensor, but cannot be shorter.
    ...
    if use_position_embeddings:
        # 限定seq_length <= max_position_embeddings
